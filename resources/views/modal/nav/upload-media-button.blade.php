<a class="[ flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 group cursor-pointer ] open-modal" modal-config-data="{{ json_encode([
    'user' => Auth::user(),
    'title' => 'Upload',
...
]) }}" modal-view-target="modal/template/media-upload-form" modal-button-type="nav">
